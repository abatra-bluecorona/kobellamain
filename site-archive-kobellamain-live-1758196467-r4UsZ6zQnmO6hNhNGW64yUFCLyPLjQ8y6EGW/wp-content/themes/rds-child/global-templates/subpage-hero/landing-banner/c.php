        ...
        <div class=" py-0">
            <div class="row pb-lg-0 pb-2 align-items-lg-center  h-613">
				...
				<div class="landing-banner-left">
                    <h1 class="true_black text_30 sm_text_23 sm_line_height_24 line_height_35 text_normal text-capitalize"><?php echo $args['page_templates']['landing_page']['banner']['subheading']; ?></<?= $subheading_tag; ?>></h1>
                    <h2 class="true_black  pb-lg-3 text_40 sm_text_30 sm_line_height_36 line_height_48 text_semibold text-uppercase"><?php echo $args['page_templates']['landing_page']['banner']['heading']; ?></<?= $heading_tag; ?>></h2>
    ...
    <span class="d-block pt-lg-1 p-alt text-center font_default text_normal text_26 line_height_31 pb-1"><?php echo $args['page_templates']['landing_page']['banner']['form_heading']; ?></span>
     ...
     <?php 
				...
				<div class="m-landing-banner-left ">
                    <span class="true_black text_29 sm_text_22 sm_line_height_35 line_height_24 text_bold text-capitalize d-block"><?php echo $args['page_templates']['landing_page']['banner']['subheading']; ?></<?= $subheading_tag; ?>></span>
                    <span class="true_black d-block pb-lg-3 text_50 sm_text_25 sm_line_height_30 line_height_60 text_bold   text-uppercase"><?php echo $args['page_templates']['landing_page']['banner']['heading']; ?></<?= $heading_tag; ?>></span>
                    <span class="display_3 pt-lg-3 true_black   pb-lg-3 mb-lg-1 pb-2 text-capitalize font_alt_2"><?php echo $args['page_templates']['landing_page']['banner']['content']; ?></span>
                    <a href="<?php echo  $args['page_templates']['landing_page']['banner']['button_link']; ?>" class="btn btn-primary mw-234 mh-43"><?php echo $args['page_templates']['landing_page']['banner']['button_text']; ?><i class="icon-chevron-right2 ms-2 me-0 bc_text_18 bc_line_height_18 transform_lg position-relative top_n2"></i> 
                    </a>
	</div>
