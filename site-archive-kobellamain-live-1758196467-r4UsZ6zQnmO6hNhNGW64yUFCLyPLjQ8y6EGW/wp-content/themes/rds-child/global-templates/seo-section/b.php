        ...
        <div class="container pt-lg-3 py-2">
            <div class="row py-lg-2">
                <div class="col-lg-12 px-0 bc_homepage seosection-bc text-md-left ">
                    ...
                    if ($template_id == 40758) {
                    ?>
                        <img src="<?php echo get_exist_image_url("about-page", "about-img"); ?>" srcset="<?php echo get_exist_image_url("about-page", "about-img"); ?> 1x, <?php echo get_exist_image_url("about-page", "about-img@2x"); ?> 2x, <?php echo get_exist_image_url("about-page", "about-img@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-none d-lg-block" width="540" height="534" alt="Homepage Image">
                        <img src="<?php echo get_exist_image_url("about-page", "m-about-img"); ?>" srcset="<?php echo get_exist_image_url("about-page", "m-about-img"); ?> 1x, <?php echo get_exist_image_url("about-page", "m-about-img@2x"); ?> 2x, <?php echo get_exist_image_url("about-page", "m-about-img@3x"); ?> 3x" class="img-fluid float-lg-end ms-lg-5 pb-lg-0 pb-4 d-lg-none d-block" width="345" height="230" alt="Homepage Image">
                    ...
                    ?>
                    <h1 class="text-lg-start "><?php echo !empty($args["page_templates"]["about_us_page"]["seo_section"]["heading"]) ? $args["page_templates"]["about_us_page"]["seo_section"]["heading"] : ''; ?></h1>
                    <h2 class="pb-lg-4 text-lg-start "><?php echo !empty($args["page_templates"]["about_us_page"]["seo_section"]["subheading"]) ? $args["page_templates"]["about_us_page"]["seo_section"]["subheading"] : ''; ?> </h2>
