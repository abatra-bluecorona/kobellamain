...
?>
 ...
 ) { ?><span class=" line_height_30  font_alt_1  text_normal  text_16 d-md-inline-block">&nbsp; | &nbsp;</span><span class="d-block d-sm-inline-block d-lg-inline-block p-alt">Web Design and Internet Marketing by<a class=" footer_copyright_links    a-alt  copyright_hover" target="_blank" href="<?php 
    echo !empty( $args["site_info"]["bluecorona_link"] ) ?  $args["site_info"]["bluecorona_link"] : '';//echo $args["site_info"]["bluecorona_link"]; ?>">&nbsp;RYNO Strategic Solutions.</a></span><?php }

 ?>
            <span class="d-lg-inline-block ">&nbsp; | &nbsp;</span><span class="d-lg-inline-block d-block"><a class=" footer_copyright_links  a-alt   copyright_hover"  href="#" data-bs-toggle="modal" data-bs-target="#disclaimer">Disclaimer</a><span class="d-inline-block">&nbsp; | &nbsp;</span><a class="  a-alt   footer_copyright_links  copyright_hover  " href="<?php echo get_home_url() .
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
              $('.elementor-element-cdfac05 .elementor-heading-title').addClass('container');
            });
    </script>
</footer>
