            ...
            <div id="navbarSupportedContent" class="navbar-collapse collapse">      
                ...
                ?>
                  <div class="w-100 px-3">
                   <form role="search" method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>" class="input-group search d-inline-flex align-items-center">
  <div class="input-group-prepend pl-5 pl-sm-0"></div>
  <div class="mobile-search w-100 d-flex" style="border-bottom:1px solid #000;">
    <input style="" type="text" value="" name="s" id="s" class="form-control rounded-0 p-0 empty-search error-search bc_font_alt_1 bc_text_semibold border-0 font_default text_16 line_height_21 h-56" placeholder="Enter to search">
    <button id="searchsubmit" aria-label="magnifying glass" type="submit" class="input-group-text p-0 bg-transparent border-0 h-56 text-center m_w_45 rounded-0 focus-outline-0 cursor-pointer">
      <i class="icon-chevron-right1 true_black text_18 line_height_18 mx-auto"></i>
    </button>
  </div>
</form>
                   </div>
