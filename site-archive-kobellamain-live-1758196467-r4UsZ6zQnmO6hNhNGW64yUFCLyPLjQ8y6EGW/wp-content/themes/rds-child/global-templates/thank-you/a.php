...
if (strpos($url, "coupon") || strpos($url, "careers")) {
    $display = "d-none";
} else {
  $display = "";
}
                ...
                <div class="col-12 col-lg-12 order-lg-1 order-1 pt-lg-1">
                    <div class="text-center">
                        ...
                        if ($temName != "rds-coupon-thankyou.php") {
                            ?>
                            <div class="text-center pt-2 <?=$display?>">
...
<div class="d-block order-2 order-lg-2" id="next-service">
    <div class="container-fluid bc-thnkyu-trust px-0  bg-light">
        <div class="container">
            <div class="row">
...
<?php if (!empty($args["page_templates"]["thankyou_page"]["show_promotions"]) && $args["page_templates"]["thankyou_page"]["show_promotions"] == 1) { ?>
    <div class="d-block order-3 order-lg-3 <?=$display?>" id="thankyou_page_promotion">
