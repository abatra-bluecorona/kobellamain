...
$charLimit = 464;
    ...
    ?>
                    ...
                    <div class="mb-lg-4">
                        ...
                        <a href="https://heartlandhomeservices.wd5.myworkdayjobs.com/Kobella/" target="_blank"><button  class="btn btn-primary mw-248"><?php echo $args['page_templates']['career_page']['banner']['button_text']; ?></button>
                    </a>
                    <?php } ?>
                    </div>
                </div>
