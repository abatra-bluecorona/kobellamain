...
<div class="sidebar_coupon pt-lg-5 mt-4 pb-lg-4 px-lg-0 px-2 mx-lg-0 mx-1 order-lg-2 order-2">
    ...
    <span
        class="font_default text_semibold text_28 line_height_33 text-center d-block pb-lg-3 sm_text_26 pb-4 sm_line_height_31">
    ...
    <div class="swiper coupon-swiper">
        <div class="swiper-wrapper">
            ...
            ?>
            <div class="swiper-slide h-auto color_primary_bg p-lg-2 p-3"
    ...
    <div class="text-center see_all_button mb-4 pb-2">
        ...
        <a href="<?php echo get_home_url() . $args['page_templates']['subpage']['sidebar']['promotion']['button_link']; ?>"
...
<div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 aa" id="sidebar_request_coupon_form" tabindex="-1"
            ...
            <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                <div class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                    ...
                    <div
                        ...
                        <span
                            class="font_alt_1 text_bold text_16 line_height_25 sm_text_16 sm_line_height_30 color_primary">
...
jQuery(document).ready(function() {
    jQuery(".coupon-popup-close").click(function() {
        ...
        jQuery(this).closest("#sidebar_request_coupon_form").find("form .gfield_label").each(function(k,
            d) {
            jQuery(d).attr("style", "");
    ...
    document.querySelectorAll('.request_service_button').forEach(function(button) {
        button.addEventListener('click', function() {
            if (document.getElementById('sidebar_request_coupon_form').classList.contains(
                    'show')) {
