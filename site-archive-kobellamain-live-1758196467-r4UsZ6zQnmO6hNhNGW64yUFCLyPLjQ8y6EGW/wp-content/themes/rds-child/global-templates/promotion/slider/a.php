...
<div class="d-block pb-lg-5">
   ...
   if (
            ...
            <div class="container px-0 px-lg-3">
                <div class="row mx-0">
                    <div class="homepage_coupon col-lg-12 px-0 pt-lg-5 mt-4 pb-lg-4 px-0">
                        <?php if (!empty($title)) { ?>
                        <h4 class="d-block text-center px-lg-0 px-3 pt-lg-0 pt-2 coupon_subtitle coupon_heading">
                            <?php echo esc_html($title); ?></h4>
                        <?php } ?>

                        <?php if (!empty($heading)) { ?>
                        <span
                            class=" d-block text-center py-2 px-lg-0 px-2 pt-lg-0 pt-2 my-lg-1 coupon_sub_heading"><?php echo esc_html($heading); ?></span>
                        <?php } ?>

                        <?php if (!empty($subheading)) { ?>
                        <span
                            class="mb-0 pb-lg-3 pt-lg-0 py-3 coupon_title coupon_offer "><?php echo esc_html($subheading); ?></span>
                        <?php } ?>
                        <div class="coupon_slider px-3 position-relative">
                           ...
                           while (have_posts()):
                              ...
                              if (
                                 ...
                                 ?>
                                    <div class="swiper-slide h-auto color_primary_bg p-3"
                                        style="background-color: <?php echo $color; ?>;">
                                        <div
                                            class="coupon_name border-dashed-5 h-coupan-100 py-4 p-4 px-lg-0 text-center">
                                            <?php if (!empty($title)) { ?>
                                            <h4
                                                class="d-block text-center px-lg-0 px-3 pt-lg-0 pt-2 coupon_subtitle coupon_heading">
                                                <?php echo esc_html($title); ?></h4>
                                            <?php } ?>
                                            ...
                                            <span
                                                class=" d-block text-center py-2 px-lg-0 px-2 pt-lg-0 pt-2 my-lg-1 coupon_sub_heading"><?php echo esc_html($heading); ?></span>
                                            <?php } ?>
                                            <a class="bc_coupon_content_parent cursor-pointer bc_toggle_btn_wide  text-decoration-none bc_text_20 bc_line_height_20 font_default  text_semibold true_black--imp text-capitalize team-conten pb-3"
                                                    data-toggle="#read_more-<?php echo $i; ?>"><span
                                                        class="text_20 line_height_20 text_semibold mt-3 font_default ">More
                                                        Info</span> <i class="icon-plus"></i> </a>
                                                <div class="bc_coupon_content d-none mt-2"
                                                    id="read_more-<?php echo $i; ?>">
                                            <?php if (!empty($subheading)) { ?>
                                            <span
                                                class="mb-0 pb-lg-3 pt-lg-0 py-3 coupon_title coupon_offer "><?php echo esc_html($subheading); ?></span>
                                            <?php } ?>
                                            ...
                                            <span class="pt-lg-3 pt-2 d-block coupon_expiry">Expires
                                                <?php echo $date; ?></span>
                                            <?php } ?>
                                            <?php if (!empty($footer_heading)) { ?>
                                            <span
                                                class="d-block coupon_disclaimer color_white"><?php echo $footer_heading; ?></span>
                                            <?php } ?>
                                            </div>
                     ...
                     if (
                        ...
                        basename($template) == "rds-landing.php"
                            ...
                            <div data-dark-color="color_primary"
                                class="apply-conditional-color swiper-pagination home-coupon-pagination-<?php echo $widget_id ?> pagination-variation-a position-relative d-lg-block d-none">
                            </div>
                            <div data-dark-color="color_primary"
                                class="apply-conditional-color swiper-pagination m-home-coupon-pagination-<?php echo $widget_id ?> pagination-variation-a position-relative d-lg-none d-block">
                            </div>
                            <div class="text-center pt-lg-3 pt-2">
                                ...
                                <a href="<?php echo get_home_url() . $args["globals"]["promotion"]["button_link"]; ?>"
                                    class="btn btn-primary mw-210"><?php echo $args["globals"]["promotion"]["button_text"]; ?></a>
                                <?php } ?>
                            </div>
                            <?php }
                     ?>
    ...
    <?php wp_reset_query(); ?>
    <div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 77" id="slider_request_coupon_form" tabindex="-1"
        role="dialog" data-bs-backdrop="false" data-bs-keyboard="false" aria-labelledby="requestcoupon_Label"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered px-lg-0 px-2 " role="document">
            <div class="modal-content border-0 rounded-0 text-center">
                <div class="modal-header border-0 p-0">
                    <button type="button"
                        class="close coupon-popup-close position-absolute bg-transparent border-0 pb-0 px-0"
                        data-bs-dismiss="modal" aria-label="Close" style="opacity:1; z-index: 999; color:#fff ;">
                        <i class="icon-xmark1 text_30 line_height_26"></i>
                    </button>
                </div>
                <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                    <div
                        class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                        ...
                        <div
                            class="my-md-0 mt-lg-4 mt-3 w-lg-260 mx-auto text-start text-lg-center d-flex align-items-center justify-content-center pb-4 px-lg-0 px-4">
                            <i
                                class="icon-shield-check1 text_30 line_height_30 me-2 position-relative color_primary"></i>
                            <span
                                class="font_alt_1 text_bold text_16 line_height_25 sm_text_16 sm_line_height_30 color_primary"><?php echo $args["globals"]["promotion"]["popup_form_subheading"]; ?></span>
                        </div>
                        <?php } ?>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery(".coupon-popup-close").click(function() {
            ...
            jQuery(this).closest("#slider_request_coupon_form").find("form .gfield_label").each(
                function(k, d) {
                    jQuery(d).attr("style", "");
...
jQuery(document).ready(function() {
    jQuery(".bc_toggle_btn_wide").on('click', function(e) {
        var $btn = jQuery(this);
        var $content = $btn.closest('.coupon_name').find(".bc_coupon_content");

        // Toggle button text
        if ($btn.find("i").hasClass("icon-minus1")) {
            $btn.find("span").text("more info");
        } else {
            $btn.find("span").text("less info");
        }

        // Toggle icon class
        $btn.find('i').toggleClass('icon-plus icon-minus1');

        // Slide toggle the content and handle d-none
        if ($content.hasClass('d-none')) {
            $content.removeClass('d-none').hide().slideDown(500);
        } else {
