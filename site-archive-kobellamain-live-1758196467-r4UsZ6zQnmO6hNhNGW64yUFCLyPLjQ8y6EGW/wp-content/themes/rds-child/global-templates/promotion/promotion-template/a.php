                ...
                <div class="container-fluid pt-4 order-1 order-lg-1 pb-lg-2 pb-4 my-2 px-lg-3 px-0">
                    <div class="container subpage_full_content pb-lg-5 px-lg-3 px-0">
                        <div class="row pb-lg-0 mx-0">
                            ...
                            <div
                                class="<?php echo $enable_sidebar === "yes" ? "col-12 col-lg-8 order-lg-1 order-1" : "col-12 col-lg-12 order-lg-1 order-1"; ?>">
                                <div class="row px-3">
                                    <?php
                                    $i = 0;
                                    if (have_posts()):
                                        while (have_posts()):
                                            ...
                                            if (function_exists("get_promotion_query")) {
                                                ...
                                                if (strtotime($date) >= strtotime(current_time("m/d/Y")) || $noexpiry == 1) {
                                                    ...
                                                    ?>
                                    <div
                                        class="<?php echo $enable_sidebar === "yes" ? "col-lg-6 mb-lg-5 mb-4 pb-lg-3" : "col-lg-4 mb-lg-5 mb-4"; ?>">
                                        <div class="h-coupan-100 color_primary_bg p-lg-3 p-3"
                                            style="background-color: <?php echo esc_attr($colorCode); ?>;">
                                            <div
                                                class="coupon_name border-dashed-5 border-lg-dashed-5 h-coupan-100 py-4 p-4 px-lg-0 text-center">
                                                <?php if (!empty($title)) { ?>
                                                <h4
                                                    class="d-block text-center px-lg-0 px-3 mt-3 pt-lg-0 pt-2 coupon_subtitle coupon_heading">
                                                    <?php echo esc_html($title); ?></h4>
                                                <?php } ?>

                                                <?php if (!empty($heading)) { ?>
                                                <span
                                                    class=" d-block text-center py-2 px-lg-0 px-2 pt-lg-0 pt-2 my-lg-2 coupon_sub_heading"><?php echo esc_html($heading); ?></span>
                                                <?php } ?>
                                                ...
                                                <div class="bc_coupon_content d-none mt-2"
                                                    ...
                                                    <span
                                                        class="pt-lg-3 pt-2 d-block coupon_expiry"><?php echo "Expires " . esc_html($date); ?></span>
                                                    <?php } ?>
                                                    <?php if (!empty($footer_heading)) { ?>
                                                    <span
                                                        class="d-block coupon_disclaimer pb-3"><?php echo esc_html($footer_heading); ?></span>
                                                    <?php } ?>
                                                </div>
                                                

                                                <a data-bs-toggle="<?php echo empty($requestButtonLink) ? "modal" : ""; ?>"
                                                        data-bs-target="<?php echo empty($requestButtonLink) ? "#request_coupon_form_template_a" : ""; ?>"
                                ...
                                <div class="row">
                                    <div
                                        class="col-md-12 d-flex align-items-center justify-content-center mt-lg-0 mt-3">
...
<div class="modal fade request_form px-lg-0 px-0 pt-5 pt-md-0 dd" id="request_coupon_form_template_a" tabindex="-1"
            ...
            <div class="modal-body p-lg-4 p-2 w-100 my-auto mx-auto coupons">
                <div class="border-dashed-7 pt-lg-4 pb-lg-4 py-4 footer_form_A ui_kit_footer_form elementor-popupform">
                    ...
                    <h3 class="px-lg-0 px-4">
                        <?php echo esc_html($args["page_templates"]["promotions"]["popup_form_heading"]); ?></h3>
                    <?php } ?>
                    <div
                        ...
                        <span
                            class="font_alt_1 text_bold text_16 line_height_25 sm_text_16  sm_line_height_30 color_primary"><?php echo esc_html($args["page_templates"]["promotions"]["popup_form_subheading"]); ?></span>
                    </div>
...
jQuery(document).ready(function() {
    jQuery(".coupon-popup-close").click(function() {
        jQuery(this).closest("#request_coupon_form_template_a").find("form .gfield_label").each(
            function(k, d) {
                jQuery(d).attr("style", "");
